              ...
              >
                ...
                <div className="p-6 bg-panel/20 border border-border rounded-sm">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {[
                      { icon: Users, label: 'GLOBAL EMPLOYEES', val: '102,451', trend: '+1.4% Monthly', color: 'text-accent-cyan' },
                      { icon: Building2, label: 'TOTAL DEPARTMENTS', val: '10 Units', trend: 'Stable Hierarchy', color: 'text-accent-blue' },
                      { icon: Layers, label: 'CORPORATE APPLICATIONS', val: '7 Primary Tools', trend: 'Compliance Audited', color: 'text-teal-400' },
                      ...
                      { icon: Cloud, label: 'CLOUD RESOURCES DEPLOYED', val: '5,920 Instances', trend: '99.98% Available', color: 'text-cyan-400' },
